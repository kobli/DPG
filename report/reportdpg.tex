...
\begin{axis}[
    ...
    enlargelimits=false,
		...
		xlabel={Camera view interpolation parameter},
...
%
%\end{tikzpicture}
%	\caption{Comparison of culling optimizations effectivity during camera flythrough in \emph{asian dragon} scene. \emph{MTPL} was set to 100.}
